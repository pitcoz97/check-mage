...
export const it = {
  ...
  home: {
    ...
    ongoing: 'Partita in corso',
    vs: 'vs {{name}}',
    yourMove: 'tocca a te',
    theirMove: 'tocca all’avversario',
    savedOnly: 'Hai una partita aperta',
    resume: 'Riprendi',
    miniLabel: 'Posizione della partita in corso',
    tagline: 'Scacchi, più le magie delle tue carte.',
    mode: 'Modalità',
    modes: {
      ranked: 'Classificata',
      casual: 'Amichevole',
  ...
  leaderboard: {
    title: 'Classifica',
    lead: 'I primi dieci giocatori per ELO.',
    loading: 'Caricamento della classifica…',
    error: 'Classifica non disponibile.',
    retry: 'Riprova',
    empty: 'Ancora nessun giocatore in classifica.',
    you: 'Tu',
  },
  settings: {
    title: 'Impostazioni',
  ...
  match: {
    ...
    hint: {
      ...
      idle: {
        ...
        main1: 'Puoi lanciare magie prima di muovere.',
        move: 'Muovi un pezzo: poi potrai ancora lanciare magie.',
        main2: 'Puoi lanciare magie dopo la mossa, poi chiudi il turno.',
        end_turn: 'Il turno sta passando all’avversario.',
        unknown: 'Attendi lo stato della partita.',
      },
      short: {
        draw: 'pesca in corso',
        main1: 'tocca una carta per lanciarla',
        move: 'muovi un pezzo',
        main2: 'lancia una magia o chiudi il turno',
        end_turn: 'turno che passa',
        unknown: 'attendi',
        opponent: 'turno dell’avversario',
      },
    ...
    mana: {
      label: 'Mana',
      note: '+1 per turno · max 10',
    },
    tabs: {
      label: 'Storico e grimorio',
      moves: 'Mosse',
      grimoire: 'Grimorio',
      chat: 'Chat',
      soon: 'Presto',
