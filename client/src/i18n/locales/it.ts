...
export const it = {
  ...
  auth: {
    ...
    checks: {
      usernameLength: 'Nome utente da 3 a 20 caratteri',
      usernameChars: 'Solo lettere, numeri e underscore',
      emailFormat: 'Indirizzo email valido',
      passwordLength: 'Password da 8 a 72 caratteri',
  ...
  errors: {
    ...
    http: {
      ...
      username_too_short: 'Il nome utente deve avere almeno 3 caratteri.',
      username_too_long: 'Il nome utente non può superare 20 caratteri.',
      ...
      password_too_long: 'La password non può superare 72 caratteri.',
