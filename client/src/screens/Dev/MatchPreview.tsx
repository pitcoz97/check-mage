 ...
 * carte, due magie nello storico). `?scenario=over|draw|reconnecting|replaced|disconnected|promotion|spells|rune`
 * aggiunge gli stati che le tavole non disegnano. Serve a confrontare la partita col design senza account né server.
 * Non esiste nella build di produzione.
 */
